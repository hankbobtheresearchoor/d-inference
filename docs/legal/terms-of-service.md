...
- you are not located in, ordinarily resident in, or using the Services for the benefit of any person or entity in a jurisdiction subject to applicable trade restrictions or sanctions;
...
- promptly notify us of suspected compromise or misuse.
...
## 4. Consumer Use of the Services

If you use the Services as a customer, developer, or end user submitting requests (collectively, a "consumer"):

- you are responsible for your prompts, uploaded files, model selections, tool calls, output use, and downstream applications;
...
- you will operate only hardware, networks, and accounts you are authorized to use;
- you will not bypass, disable, spoof, tamper with, or interfere with attestation, security, integrity, enrollment, metering, payout, or routing controls;
- you will maintain your machine, operating system, software, model files, and security settings in a safe and compliant state, including maintaining System Integrity Protection (SIP) and Secure Boot enabled at all times;
- you will not attempt to inspect, exfiltrate, intercept, or misuse customer content processed through the Services;
- you remain responsible for local taxes, reporting, labor, employment, power, internet, hardware, and other operating costs;
- any earnings or payouts may be delayed, reversed, withheld, or adjusted for fraud, abuse, disputes, sanctions screening, chargebacks, compliance review, accounting corrections, or system errors.
- you are enrolling a personally owned device and accept the risks associated with granting administrative control.
...
- credits are non-interest-bearing and are not bank accounts, checking accounts, savings accounts, or stored-value accounts unless we expressly state otherwise;
- credits are usable only for eligible Services;
- except as required by law or expressly stated in writing, prepaid purchases are final and non-refundable;
- credits may be adjusted to correct errors, fraud, abuse, duplicate transactions, or chargebacks.
...
- use the Services for illegal, fraudulent, harmful, infringing, or deceptive activity;
- exploit, harm, or attempt to exploit or harm minors;
- submit or generate material that violates law or third-party rights;
- use the Services to develop malware, phishing infrastructure, credential theft, unauthorized surveillance, or other malicious code or conduct;
- probe, scan, reverse engineer, benchmark without permission, or attempt to discover source code or model weights except as allowed by applicable law and not waivable by contract;
- interfere with or disrupt the Services, providers, networks, or security controls;
- circumvent rate limits, usage restrictions, access controls, or safety mechanisms;
- use automated means to scrape the Services except through authorized APIs;
- use the Services in a manner that could create a competing service based on unauthorized extraction of outputs, metadata, or system behavior;
- misrepresent Outputs as solely human-generated where doing so would be deceptive or unlawful;
- use the Services for medical diagnosis or treatment, legal advice, financial advice, emergency response, critical infrastructure control, or other high-risk use cases where a failure could reasonably cause death, personal injury, or significant property or environmental harm, unless we expressly authorize that use in writing.
...
- you own your Outputs to the extent any ownership rights arise in them and are transferable, excluding our underlying Services, software, models, documentation, trademarks, and other intellectual property;
- you grant us and our subprocessors, providers, and infrastructure partners a non-exclusive, worldwide, limited license to host, copy, transmit, process, display, and use Inputs and Outputs solely as necessary to provide, secure, maintain, bill for, enforce, and improve the Services, comply with law, and prevent fraud, abuse, or misuse.
...
- the Services involve transmission, processing, and storage of Inputs, Outputs, and service metadata;
- we use reasonable technical and organizational safeguards, but no method of transmission, storage, or processing is completely secure;
- certain service paths may use additional encryption, attestation, or trusted-execution features, but those controls do not eliminate all risk;
- you are responsible for using the Services in a manner appropriate for the sensitivity of your data.
...
- third-party wallets, payment processors, authentication providers, and blockchain networks are not controlled by us;
- provider machines participating in the network may be independently operated by third parties, even where subject to our technical requirements;
- the security verification features of the Services depend on Apple infrastructure including MDM, APNs, Secure Enclave, and System Integrity Protection, which are operated and controlled by Apple and subject to Apple's policies;
- we are not responsible for third-party outages, hacks, policy changes, fees, transaction failures, delays, or data practices.
...
- we suspect fraud, abuse, sanctions issues, or unauthorized access;
- required third-party services are unavailable or terminate their relationship with us, including Apple infrastructure on which security verification features depend;
...
- that the privacy-preserving architecture will be effective against kernel zero-day exploits, undisclosed Apple hardware vulnerabilities, or other attacks outside the scope of the current threat model.

## 15. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW:

- EIGEN LABS AND ITS AFFILIATES, LICENSORS, PROVIDERS, AND SERVICE PROVIDERS WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, GOODWILL, DATA, BUSINESS INTERRUPTION, DAMAGE TO DEVICES, OR OTHER INTANGIBLE LOSSES, EVEN IF ADVISED OF THE POSSIBILITY OF THOSE DAMAGES;
- OUR AGGREGATE LIABILITY ARISING OUT OF OR RELATING TO THE SERVICES OR THESE TERMS WILL NOT EXCEED USD $100.
...
- your Inputs, Outputs, applications, or products built with the Services;
- your breach of these Terms;
- your violation of law or third-party rights.
- your violation of any applicable open-source model license terms.
...
- be administered by JAMS under its then-current comprehensive arbitration rules;
- be conducted in English before a single arbitrator;
- be governed by the Federal Arbitration Act to the extent applicable.
...
- claims must be brought only in an individual capacity and not as a plaintiff or class member in any purported class, collective, consolidated, mass, or representative proceeding;
- the arbitrator may not consolidate more than one person's claims and may not preside over any class, collective, or representative proceeding;
- if this class-action waiver is found unenforceable as to a particular claim, then that claim must proceed in a court of competent jurisdiction and not in arbitration.
...
- claims seeking only temporary, preliminary, or permanent injunctive relief;
- claims relating to intellectual property, misuse of intellectual property, or unauthorized access to the Services.
...
For notices, questions, or complaints about these Terms, contact:
